...
public class PastSales extends ListActivity {
    public static final String KEY_121 = "http://207.179.202.218:1515/joe/3.php";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_past_sales, menu);
        return true;
    }
